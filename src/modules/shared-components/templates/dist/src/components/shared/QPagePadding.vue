...
const topFloatPadding = props.topFloatPadding === undefined
  ? requiredConfigEntries('topFloatPadding').topFloatPadding
  : props.topFloatPadding
const bottomFloatPadding = props.bottomFloatPadding === undefined
...
function styleFn (offset: number, height: number) {
  const fixedPadding = props.fixedPadding === undefined
...
<template>
  ...
  >
    <div
      :style="{ paddingTop: `${topFloatPadding}px`,
