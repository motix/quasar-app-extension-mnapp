...
export default defineUninstall(function (api) {
    ...
    api.extendJsonFile('package.json', {
        dependencies: Object.fromEntries(dependencies.map((item) => [item, packagesOriginalVersion[item]])),
        devDependencies: Object.fromEntries(devDependencies.map((item) => [item, packagesOriginalVersion[item]])),
    });
